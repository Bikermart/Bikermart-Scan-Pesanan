...
$(function() {
    ...
    var App = {
        ...
        attachListeners: function() {
            ...
            $("#cameraStop").on("click", function(e) {
                e.preventDefault();
                Quagga.stop();
            ...
            $("#deviceSelection").on("change", "select", function(e) {
                e.preventDefault();
                var $target = $(e.target);
                   // value = $target.attr("type") === "checkbox" ? $target.prop("checked") : $target.val(),
                   value =  $target.attr("type") === "checkbox" ? this.querySelectedReaders() : $target.val();
    ...
    Quagga.onDetected(function(result) {
        ...
        if (App.lastResult !== code) {
            ...
            if(confirm('Kode yang terbaca adalah ' + code + ', Apakah ingin mengulangi proses scan?')) {
                location.reload();
            } else {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if(result.status == 'ok') {
                            $('#notifSukses').show();
                            $('#notifSukses small').text(result.data)
